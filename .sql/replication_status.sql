select * from ffba_cashreg_log where id >= 60588 and identity='eltapos_001' order by create_dt desc;
select count(*) from ffba_cashreg_log where identity='eltapos_001';
delete from ffba_cashreg_log where identity='eltapos_001' and id < 60588;


select * from ffba_cashreg_log where id >= 60590 and identity='eltapos_002' order by create_dt desc;
select count(*) from ffba_cashreg_log where identity='eltapos_002';
delete from ffba_cashreg_log where identity='eltapos_002' and id < 60590;


select * from ffba_cashreg_log where id >= 60589 and identity='eltapos_003' order by create_dt desc;
select count(*) from ffba_cashreg_log where identity='eltapos_003';
delete from ffba_cashreg_log where identity='eltapos_003' and id < 60589;
